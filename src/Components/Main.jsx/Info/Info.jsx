    ...
    <div>
      <div className={style.games}>
        <div className={style.first}>
          <img src="https://demo2.wpopal.com/gamico/wp-content/uploads/2023/12/h2_img4.png" />
          <div>
        ...
        <div className={style.second}>
          ...
          <img src="https://demo2.wpopal.com/gamico/wp-content/uploads/2023/12/h2_img5.png" />
        </div>
        <div className={style.third}>
          <img src="https://demo2.wpopal.com/gamico/wp-content/uploads/2023/12/h2_img6.png" />
          <div>
            <h1>ART DIRECTION</h1>
            <p>
      ...
      <div className={style.counter}>
        ...
        <p>“WE MAKE THE GAMES WE'D LOVE TO PLAY”</p>
        <h3>ALEX GRANT, <span>FOUNDER</span></h3>
      </div>
        </div>
    </div>
  );
